  ...
  const initProgressiveImages = async () => {
    ...
    images.forEach((img) => {
      ...
      if (!img.hasAttribute("loading")) {
        img.setAttribute("loading", isPrimaryHeroImage ? "eager" : "lazy");
      }

      if (isPrimaryHeroImage && img.getAttribute("loading") === "lazy") {
        img.setAttribute("loading", "eager");
      }

      if (isPrimaryHeroImage && !isBrand) {
        img.setAttribute("fetchpriority", "high");
      } else if (inHero && img.hasAttribute("fetchpriority")) {
